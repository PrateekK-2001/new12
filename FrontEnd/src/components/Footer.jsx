  ...
  return (
    <footer className="footer-container">
      ...
      <div className="content">
        <div>
          <img src="/HOSPITALLogoo.png" alt="logo" className="logo-img" />
        </div>
        <div>
          <h4>Quick Links</h4>
          <ul>
        ...
        <div>
          <h4>Contact</h4>
          <div>
            <FaPhone /> <span>880-822-8921</span>
          </div>
          <div>
            <MdEmail /> <span>Prateek@gmail.com</span>
          </div>
          <div>
            <FaLocationArrow /> <span>Varanasi, India</span>
          </div>
        </div>
      </div>
    </footer>
